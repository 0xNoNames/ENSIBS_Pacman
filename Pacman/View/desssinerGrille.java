                ...
                if (grille[i][j] instanceof Jouable) {
                    ...
                    if (caseJ.getObjet() != null) {
                        ...
                        case "Orange":
                            ...
                            break;
                        case "Pomme":
                            g2d.drawImage(data.getFruitSprites()[3], (i * 8), (8 * j) + 24, null);
                            break;
                        case "Melon":
                            g2d.drawImage(data.getFruitSprites()[4], (i * 8), (8 * j) + 24, null);
                            break;
                        case "Galboss":
                            g2d.drawImage(data.getFruitSprites()[5], (i * 8), (8 * j) + 24, null);
                            break;
                        case "Cloche":
                            g2d.drawImage(data.getFruitSprites()[6], (i * 8), (8 * j) + 24, null);
                            break;
                        case "Clé":
                            g2d.drawImage(data.getFruitSprites()[7], (i * 8), (8 * j) + 24, null);
                            break;
                        case "PetiteGomme":
